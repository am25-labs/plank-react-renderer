...
React renderer for [Plank CMS](https://github.com/plank-cms/plank) rich text content. Converts the Tiptap JSON output from the `RichText` field into React elements, with full support for custom components per node type.
